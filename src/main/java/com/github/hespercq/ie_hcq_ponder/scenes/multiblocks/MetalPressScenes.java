...
public class MetalPressScenes {
  ...
  public static void forming(SceneBuilder builder, SceneBuildingUtil util) {
    ...
    final String sceneId = "metal_press/forming";
    final String sceneTitle = "Forming the Metal Press Multiblock";
    final ResourceLocation multiBlockRL = IE.rl("multiblocks/metal_press");

    final Selection multiBlockSelection = util.select().fromTo(1, 4, 2, 3, 6, 2);
